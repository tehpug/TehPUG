...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'projects_project', (
            ...
            ('language', self.gf('django.db.models.fields.CharField')(default='0', max_length=1)),
            ...
            ('license', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True)),
            ('home', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('vcs', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True)),
            ('downloadlink', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('weight', self.gf('django.db.models.fields.IntegerField')(default=40)),
            ('kproject', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        m2m_table_name = db.shorten_name(u'projects_project_maintainers')
        ...
        db.create_table(u'projects_repository', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project'])),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=265)),
            ('weight', self.gf('django.db.models.fields.IntegerField')(default=40)),
        ))
        db.send_create_signal(u'projects', ['Repository'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'projects_project_maintainers'))

        # Deleting model 'Repository'
        db.delete_table(u'projects_repository')
