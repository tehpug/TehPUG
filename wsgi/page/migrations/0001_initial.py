...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'page_page', (
            ...
            ('lang', self.gf('django.db.models.fields.CharField')(default='fa', max_length=8)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('weight', self.gf('django.db.models.fields.IntegerField')(default=50)),
        ))
        db.send_create_signal(u'page', ['Page'])

        # Adding model 'FirstPage'
        db.create_table(u'page_firstpage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('content', self.gf('django.db.models.fields.TextField')()),
        ...
        db.send_create_signal(u'page', ['FirstPage'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'FirstPage'
        db.delete_table(u'page_firstpage')
